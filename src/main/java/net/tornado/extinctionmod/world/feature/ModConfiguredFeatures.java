...
public class ModConfiguredFeatures {
    ...
    public static final List<OreFeatureConfig.Target> OVERWORLD_FOSSIL_BLOCK = List.of(
            OreFeatureConfig.createTarget((OreConfiguredFeatures.STONE_ORE_REPLACEABLES), BlockInit.FOSSIL_BLOCK.getDefaultState()),
            OreFeatureConfig.createTarget((OreConfiguredFeatures.DEEPSLATE_ORE_REPLACEABLES), BlockInit.FOSSIL_DEEPSLATE_BLOCK.getDefaultState()));
