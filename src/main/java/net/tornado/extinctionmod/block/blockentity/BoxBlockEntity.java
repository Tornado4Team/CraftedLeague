package net.tornado.extinctionmod.block.blockentity;
...
import net.tornado.extinctionmod.item.inventory.ImplementedInventory;
import net.tornado.extinctionmod.recipe.BoxRecipe;
...
public class BoxBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public BoxBlockEntity(BlockPos pos, BlockState state) {
        super(ExtinctionMod.BOX_BLOCK_ENTITY, pos, state);
