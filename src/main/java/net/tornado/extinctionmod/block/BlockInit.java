...
public class BlockInit {
    ...
    public static final Block FRAME_BLOCK = registerBlock( "frame_block", new Block(FabricBlockSettings.of(Material.METAL).strength(6f).requiresTool()), ModItemGroup.EXTINCTION);
